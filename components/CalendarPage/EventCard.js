...
const EventCard = ({ eventData }) => {
  ...
  return (
    <div className="bg-white rounded-xl w-full lg:w-72 flex lg:block lg:h-auto">
      <div className="bg-gray-800 relative overflow-hidden group w-1/3 h-auto lg:w-full lg:h-40 rounded-l-xl lg:rounded-t-xl lg:rounded-bl-none">
        {/* Capa do evento */}
        <img
      ...
      <div className="w-2/3 lg:w-full">
        ...
        <div className="p-4 border-r-2 border-t-2 rounded-tr-lg lg:border-l-2 lg:border-t-0 lg:rounded-none  border-gray-100">
          <h3 className="font-bold text-lg line-clamp-1">{eventData.title}</h3>
          {/* Endereço */}
          ...
          <div className="flex justify-end lg:justify-center mt-4">
            {/* Ações */}
